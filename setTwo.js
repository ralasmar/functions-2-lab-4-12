...
// CODE HERE 
const contains = (array, personsName, cb) => {
    if (array.includes(personsName)){      
      cb(true)
    } else{
      cb(false)
    }
...
const each = (array, cb) => array.forEach((value, i) => cb(value, i))     //using .forEach method 
...
return (favoriteNumber) => {
  console.log(num1 + favoriteNumber)
}
}
let addSix = addingFactory(6)

console.log(addSix(17))
